        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p>
                        - If you are using an LDM, or a bugfix copy of a level, it must either be approved by list staff, or obviously fine. Use your best judgement here, if you are uncertain whether or not your bugfix copy/LDM of a level can be accepted, file a support ticket with the level ID. However, if you're absolutely certain that your copy is fine, you don't need to get it approved in order to get your record accepted. If you're unaware of what an "acceptable" copy would be, go ahead and file a support ticket. (We deny copies that either change gameplay of the level, or remove so much detail that it makes the level easier.
                    </p>
                    <p>
                        - The record has been achieved without using a secret way or a bugged route
                    </p>
                    <p>
                        - Your record must have an uncut end screen. If your video ends before we see the end screen, and your stats are not visible, it is not an acceptable record.
                    </p>
                    <p>
                        - If your record is found in the top 250, you must have raw footage linked, no matter what. However, if you have the record on your Pointercrate profile, you may submit that in the additional info instead, and we will accept your record.
                    </p>
                    <p>
                        - This should be obvious, but your record may not be completed with any disallowed mods. This rule also applies to having a red/blue cheat indicator, obvious hacked completions, and bots.
                    </p>
                    <p>
